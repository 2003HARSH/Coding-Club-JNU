...
// Function to find a student by phone, enrollmentNumber, and subjectCode
...
router.post('/StudentRegistration', async (req, res) => {
  ...
  try {
    // Ensure we await the StudentFind function
    ...
    // If student does not exist, proceed to register
